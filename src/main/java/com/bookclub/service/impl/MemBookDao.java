...
public class MemBookDao implements BookDao {
    ...
    public MemBookDao() {
        books.add(new Book("9780544003415", "The Lord Of The Rings",
        ...
        books.add(new Book("9780425269404", "Patriot Games",
        ...
        books.add(new Book("9781501192272", "The Talisman",
        ...
        books.add(new Book("9780446676090", "The Notebook",
        ...
        books.add(new Book("9780451474636", "The Forgotten Room",
